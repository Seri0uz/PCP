...
// c) -> Nein das macht keinen Sinn, da  mit der Funktion init schon ein leerer Stack zur Verfügung gestellt wird.
//Der dynamisch reservierte Speicher musss nicht freigegeben werden